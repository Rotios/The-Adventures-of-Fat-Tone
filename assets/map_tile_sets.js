Game.MapTileSets = {
      ...
      generator.create(function(x,y,v) {
        if (v === 0) {
          ...
          if (y >= 16 && y <= 18) {
            ...
            if (x == 30 && y == 1) mapTiles[x][y] = Game.Tile.wallTile;
      ...
      generator.create(function(x,y,v) {
        if (v === 0) {
          ...
          if (y >= 16 && y <= 18) {
            ...
            if (x == 30 && y == 1) mapTiles[x][y] = Game.Tile.wallTile;
            else if (x == 30 && y == 33 ) mapTiles[x][y] = Game.Tile.toBedTile;
            else if (y != 1 && y != 33) mapTiles[x][y] = Game.Tile.roadTile;
          }
          // Unique Tiles for the Shop
          else if (x == 23 && y == 14 ) mapTiles[x][y] = Game.Tile.shopDoorTile;
          else if (x == 22 && y == 14 ) mapTiles[x][y] = Game.Tile.shopDoorTile;
  ...
  theRedHeeringa: {
    ...
    getMapTiles: function () {
      ...
      generator.create(function(x,y,v) {
        if (v === 1){
          if (y == 13 && x >= 9 && x <= 11) mapTiles[x][y] = Game.Tile.toTownTile;
          else mapTiles[x][y] = Game.Tile.wallTile;
        } else {
  ...
  shopAndStop: {
    ...
    getMapTiles: function () {
      ...
      generator.create(function(x,y,v) {
        if (v === 1){
          if (y == 13 && x >= 10 && x <= 12) mapTiles[x][y] = Game.Tile.toTownTile;
          else mapTiles[x][y] = Game.Tile.wallTile;
        } else {
